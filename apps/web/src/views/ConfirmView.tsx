        ...
        <div className="bg-panel px-[22px] pb-[22px] pt-5">
          ...
          >
            ...
            {editing ? (
              <Textarea
                ...
                className="rounded-none border-0 bg-transparent px-[14px] py-[15px] text-[12.5px] leading-[1.75] text-fg caret-accent focus:outline-none"
              />
            ) : (
          ...
          <div className="mt-[18px] flex flex-wrap items-center gap-x-[13px] gap-y-3">
            <Button
              ...
              className="border-accent bg-accent-ghost text-[13.5px] shadow-[0_0_26px_var(--accent-soft)]"
            >
            ...
            {editing ? (
              <>
                <Button
                  ...
                  className="border-accent bg-transparent text-[13.5px]"
                >
                  Save changes
                </Button>
                <Button variant="ghost" onClick={discard} className="text-[13.5px]">
                  Discard
                </Button>
