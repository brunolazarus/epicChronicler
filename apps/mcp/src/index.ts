...
// ---------------------------------------------------------------------------
// Shared MCP server instance (used by both transports)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Stdio transport (local clients — unchanged)
// ---------------------------------------------------------------------------
...
/**
 * Auth check: if MCP_API_KEY is set, enforce `Authorization: Bearer <key>`.
 * Returns true if the request is allowed; writes a 401 and returns false otherwise.
 * When MCP_API_KEY is not set (dev mode) all requests are allowed.
 */
